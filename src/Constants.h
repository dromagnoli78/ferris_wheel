...
#define BUTTON_CONTROLS_DELTA_TIME 180
...
#define LED_SLEEP_COLOR strip.ColorHSV(242 * 182.04, 255, SLEEP_LED_INTENTISY)
#define LED_LIGHTS_COLOR strip.ColorHSV(90 * 182.04, 255, CONSOLE_LIGHTS_INTENSITY)
#define LED_STEPPER_COLOR strip.ColorHSV(180 * 182.04, 255, CONSOLE_LIGHTS_INTENSITY)
